  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      darkTheme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor:
              Colors.blueAccent, // Keep the same seed color for consistency
      ...
      home: UIModeSwitcher(
        // Pass theme control to UIModeSwitcher
...
class _UIModeSwitcherState extends State<UIModeSwitcher> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _isMinimalMode ? 'LumiAI - Minimal Mode' : 'LumiAI - Partial Mode',
        ),
      ...
      body: _isMinimalMode
          ? const MinimalFunctionalUI()
          : const PartialFunctionalUI(),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: _toggleUIMode,
        label: Text(
          _isMinimalMode ? 'Switch to Partial UI' : 'Switch to Minimal UI',
        ),
